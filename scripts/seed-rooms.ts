...
const allPuzzles: Record<string, any[]> = {
  'html-island': [
    { puzzle_number: 1, title: 'The Missing Title', description: 'Add a <title> tag to the head. Set the title text to "HTML Island".', story_context: 'Ghost: "Name your ship or sink with it."', broken_code: '<html>\n  <head>\n  </head>\n  <body>\n    <h1>Welcome</h1>\n  </body>\n</html>', correct_solution: '<html>\n  <head>\n    <title>HTML Island</title>\n  </head>\n  <body>\n    <h1>Welcome</h1>\n  </body>\n</html>', validation_type: 'contains_check', validation_value: '<title>HTML Island</title>', language: 'html', difficulty: 1, hint_1: 'Check the head.', hint_2: 'Use <title>.', hint_3: '<title>HTML Island</title>', order_index: 1, xp_reward: 50 },
    { puzzle_number: 2, title: 'Broken Link', description: 'Fix the href attribute. Set the destination to "/exit".', story_context: 'Ghost: "The link is dead. Revive it."', broken_code: '<a >EXIT</a>', correct_solution: '<a href="/exit">EXIT</a>', validation_type: 'contains_check', validation_value: 'href="/exit"', language: 'html', difficulty: 1, hint_1: 'Use href.', hint_2: 'Target is "/exit".', hint_3: 'href="/exit"', order_index: 2, xp_reward: 50 },
  ],
  'css-coral-reef': [
